...
The API will be available at: http://localhost:3001/docs

**Option 2** 
**— Run without Docker** 
Create virtual environment: python -m venv venv 
Activate environment: Linux / Mac: source venv/bin/activate I
nstall dependencies: pip install -r requirements.txt 
Run the application: uvicorn app.main:app --reload --port 3001 
...
Example 
Request GET /addresses/near?lat=12.9716&lon=77.5946&distance=5 
